...
with st.sidebar:
    Logo = Image.open('assets/MEAA.png')          
    st.image(Logo)
...
# ── HOME ─────────────────────────────────────────────────────────────────────
if selected5 == "Home":
    home_image1 = Image.open('assets/home_image1.jfif')     
    ...
    if add_selectbox == "How it works":
        ...
        home_image2 = Image.open('assets/Home_image2.png') 
        ...
        home_image3 = Image.open('assets/home_image3.jfif')  
        ...
        home_image4 = Image.open('assets/home_image4.png')  
    ...
    if add_selectbox == "Further expansions":
        ...
        with tab1:
            ...
            home_image5 = Image.open('assets/home_image5.jpg')
        ...
        with tab2:
            ...
            home_image6 = Image.open('assets/home_image6.jfif') 
        ...
        with tab3:
            ...
            home_image7 = Image.open('assets/home_image7.png')
...
if selected5 == "Upload":
    ...
    home_image8 = Image.open('tests/sample_images/test_snow.jpg') 
        ...
        try:
            with loading.container():
                with st.spinner("Loading...💫"):
                    loading_indicator = st.write("loading... please wait")

            im.save("assets/sample.png")                                        
            description = []
            description += [imageModel("models/terrain_model.h5",      "models/terrain_labels.txt",      "assets/sample.png")]   # updated
            description += [imageModel("models/landscape_model.h5",    "models/landscape_labels.txt",    "assets/sample.png")]   # updated
            description += [imageModel("models/snownosnow_model.h5",   "models/snownosnow_labels.txt",   "assets/sample.png")]   # updated
